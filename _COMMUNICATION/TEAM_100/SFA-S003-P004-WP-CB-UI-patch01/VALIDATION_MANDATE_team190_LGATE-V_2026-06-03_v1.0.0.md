...
- **C5 (constitutional):** delivery-tier only (no `_aos/`/Python/migration); palette unchanged (#f8fbf8, no cream); classb.css last; composer green (149); validate_aos 0 FAIL; IR#4 (no builder roadmap edit).
