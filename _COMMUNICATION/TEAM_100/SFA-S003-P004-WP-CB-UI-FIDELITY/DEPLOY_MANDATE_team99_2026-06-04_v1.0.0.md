...
- **SEQUENCING — DECIDED by team_00 (2026-06-04): HOLD this deploy.** Order is: (1) team_190 closes **patch01 L-GATE_V R2 on the currently-live `6703313`** → patch01 LOD500; (2) **THEN** team_99 deploys this FIDELITY HEAD; (3) **THEN** team_190 FIDELITY L-GATE_V on the new live (must regression-confirm patch01 WI-5/6/mobile still hold — FIDELITY is stacked on top; WI-9 re-verifies mobile). **Do NOT deploy FIDELITY until patch01 L-GATE_V R2 has PASSED on `6703313` and team_100 releases this mandate.**
