...
def _make_variety(**kwargs):
    ...
    # WP-CB-MIG: renamed from days_to_germinate_gh (Canon §7.1)
    v.nursery_days_to_germinate = kwargs.get("nursery_days_to_germinate", None)
    ...
    # WP-CB-MIG: facts in enrichments, categoricals in attributes (empty in mock)
    v.enrichments               = kwargs.get("enrichments", [])
    v.attributes                = kwargs.get("attributes", [])
    return v
