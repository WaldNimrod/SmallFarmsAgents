"""ShamHydroGuideImporter — L09 Israeli hydro vegetable guide.

SFA-S003-P002-WP-C2 LOD400 §4.
Reads cached JSON from data/external_sources/extracted/sham_hydro_guide/.
Per-crop JSON files with Hebrew crop_he key.
Populates: hydro_suitability.
"""
...
class ShamHydroGuideImporter(NIImporter):
    name = "sham_hydro_guide_v1"
    cache_dir = Path("data/external_sources/extracted/sham_hydro_guide")
    canonical_pdf_filename = "L09_hydro_vegetable_guide.pdf"
