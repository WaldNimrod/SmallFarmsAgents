...
IL_CROP_MAP: dict[str, str] = {
    "ארוגולה": "ארוגולה",
    "רוקט": "ארוגולה",            # WP-C2: sham_hydro_guide uses plain "רוקט"
    "רוקט/אורגולה": "ארוגולה",
    "רוקט/ארוגולה": "ארוגולה",
    "אוסנה": "אוסנה",               # WP-C2: Blackberry (added to crops table id=61)
    "אבטיח": "אבטיח",
    "אדום": "חסה",
    "איסברג": "חסה",
    ...
    "עולש\u00a0(ציקוריה)": "ציקוריה",
    "עלים": "חסה",
    "פאק ציוי": "פאק צ'וי",         # WP-C2: sham_hydro_guide uses "פאק ציוי" (ללא גרשיים)
    "פאק צוי": "פאק צ'וי",          # variant without geresh
    "פול": "פול",
    "פטרוזיליה": "פטרוזיליה",
    "פטרוזליה": "פטרוזיליה",
    "פלפל": "פלפל",
    ...
    "קולורבי": "קולורבי",
    "קולרבי": "קולורבי",
    "קולרובי": "קולורבי",          # WP-C2: sham_hydro_guide uses "קולרובי" (ו after ר)
    "קייל": "קייל",
    "קישוא": "קישוא",
    "ראש": "חסה",
    "שום": "שום",
